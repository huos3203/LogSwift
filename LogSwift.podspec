#
#  Be sure to run `pod spec lint LogSwift.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/it-boyer/LogSwift.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "LogSwift/**/*.{swift,h}"
#  s.exclude_files = "Classes/Exclude"
  ...
  # s.xcconfig = { "HEADER_SEARCH_PATHS" => "$(SDKROOT)/usr/include/libxml2" }
   s.dependency "RNCryptor", "~> 5.1.0" #:git => 'https://github.com/rnapier/RNCryptor.git'
end
